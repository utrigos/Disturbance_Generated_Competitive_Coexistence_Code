...
% The function f_i in the paper (here is where we include r_i=b_i)

A1 = 1; %alpha values
A2 = 1;

BirthFunction1 = b.*max(1-(A1.*nk+A2.*mk),0); %Max

B = trapz(a,rhok.*nk.*BirthFunction1).*ones(length(a),1); %reproduction term
end