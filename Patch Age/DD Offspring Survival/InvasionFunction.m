function [Result, AcVal, CFL] = InvasionFunction(BirthRes, DeathRes, BirthInvade, DeathInvade, Gamma, InvType,alpha1,alpha2)
...
[n,m,SI,SJ] = TwoSpecies(Na,Nt,amax,tmax,InitConRes,InitConInvade,BirthRes,DeathRes,BirthInvade,DeathInvade, InvType, Gamma, alpha1,alpha2);
...
%% AC value
if max(alpha2.*n(:,end)+alpha2.*m(:,end))>=1
        AcVal= 0;
else
        AcVal=1;
end
