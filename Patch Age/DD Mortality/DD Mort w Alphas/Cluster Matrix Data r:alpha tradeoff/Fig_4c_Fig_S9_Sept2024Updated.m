...
elseif i == 2
    %% fig S9b
            gamma = 0.25;
                ...
                Matrix = readmatrix('Matrix_Func_bj_2.34_alphaj_0.75_g_0.25.csv');
                Matrix2 = readmatrix('Matrix2_Func_bj_2.34_alphaj_0.75_g_0.25.csv');
                MutInvMat = readmatrix('MutInvadeMatrix_Func_bj_2.34_alphaj_0.75_g_0.25.csv');
                Birth2 = readmatrix('Birth2_Func_bj_2.34_alphaj_0.75_g_0.25.csv'); 
                Alpha2 = readmatrix('Alpha2_Func_bj_2.34_alphaj_0.75_g_0.25.csv');
                InvType = 2;
...
elseif i == 3
    %% fig S9c
           gamma = 0.75;
                ...
                Matrix = readmatrix('Matrix_Func_bj_2.34_alphaj_0.75_g_0.75.csv');
                Matrix2 = readmatrix('Matrix2_Func_bj_2.34_alphaj_0.75_g_0.75.csv');
                MutInvMat = readmatrix('MutInvadeMatrix_Func_bj_2.34_alphaj_0.75_g_0.75.csv');
                Birth2 = readmatrix('Birth2_Func_bj_2.34_alphaj_0.75_g_0.75.csv'); 
                Alpha2 = readmatrix('Alpha2_Func_bj_2.34_alphaj_0.75_g_0.75.csv');
                InvType = 2;
...
%% pcolor start
    ...
    spi =pcolor(Alpha2,Birth2,Matrix);
%     spi.FaceAlpha = 0.7;
    spi.DisplayName ='Species $i$ invades';
    hold on;
    
    spj = pcolor(Alpha2,Birth2,2*Matrix2);
%     spj.FaceAlpha = 0.7;
    spj.DisplayName ='Species $j$ invades';
    hold on;
    
    coex = pcolor(Alpha2,Birth2,3*MutInvMat);
