function [n,CFL] = OneSpecies(Na,Nt,initcon,amax, tmax,birth,death,gamma,alpha1,alpha2)
...
for k = 1:length(t)-2
   RepoN = ReproductionFunction1(a,n(:,k),m(:,k),rho(:,k),b);
   DeathN = DeathFunction1(a,n(:,k),m(:,k),rho(:,k),mu,a1,a2);
   FluxN = HRAgeFlux(n(:,k));
   ...
   s=k+1;
   RepoN = ReproductionFunction1(a,n(:,s),m(:,s),rho(:,s),b);
   DeathN = DeathFunction1(a,n(:,s),m(:,s),rho(:,s),mu,a1,a2);
   FluxN = HRAgeFlux(n(:,s));
