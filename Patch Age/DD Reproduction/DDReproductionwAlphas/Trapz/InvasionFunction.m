function [Result,AcVal] = InvasionFunction(BirthRes, DeathRes, BirthInvade, DeathInvade, Gamma, InvType,alpha1,alpha2)
...
n = OneSpecies(Na,Nt,initcon,amax, tmax,BirthRes,DeathRes,Gamma,alpha1,alpha2); 
...
%% AC value
if max(alpha1.*n(:,end)+alpha1.*m(:,end))>=1
           AcVal= 0;
else
            AcVal=1;
end
