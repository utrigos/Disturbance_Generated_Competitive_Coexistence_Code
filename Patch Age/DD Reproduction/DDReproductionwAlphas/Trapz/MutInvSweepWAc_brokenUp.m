...
if part ==1
Death2 = 8:StepSizeD:10; %I scale these linearly, but they can have any upper bound.
elseif part>1
Death2 = 2*part+6+StepSizeD:StepSizeD:2*part+8; %I scale these linearly, but they can have any upper bound.
end
