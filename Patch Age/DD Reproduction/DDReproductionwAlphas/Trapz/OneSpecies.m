function n = OneSpecies(Na,Nt,initcon,amax, tmax,birth,death,gamma,alpha1,alpha2)
...
for k = 1:length(t)-2
   RepoN = ReproductionFunction1(a,n(:,k),m(:,k),rho(:,k),b,alpha1,alpha2);
   ...
   s=k+1;
   RepoN = ReproductionFunction1(a,n(:,s),m(:,s),rho(:,s),b,alpha1,alpha2);
